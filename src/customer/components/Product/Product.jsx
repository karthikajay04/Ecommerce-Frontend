  ...
  const handleFilter = (value, sectionId) => {
    ...
    if (currentValues.includes(value)) {
      ...
      if (updatedValues.length === 0) {
        ...
        searchParams.set(sectionId, updatedValues.join(','));
      }
    } else {
          ...
          <DialogPanel className="relative ml-auto flex size-full max-w-xs flex-col overflow-y-auto bg-white pt-4 pb-6 shadow-xl">
            <div className="flex items-center justify-between px-4">
              ...
              <button
                ...
                className="-mr-2 flex size-10 items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-50"
              >
                      ...
                      <h3 className="-mx-2 -my-3 flow-root">
                        <DisclosureButton className="group flex w-full items-center justify-between px-2 py-3 text-gray-400 hover:text-gray-500">
                          ...
                          <span className="ml-6 flex items-center">
                            <PlusIcon className={`size-5 ${open ? 'hidden' : ''}`} />
                            <MinusIcon className={`size-5 ${!open ? 'hidden' : ''}`} />
                          </span>
                        </DisclosureButton>
                      </h3>
                    ...
                    <>
                      ...
                      <DisclosurePanel className="pt-4">
                        <FormControl component="fieldset" className="pl-2">
                          <FormLabel component="legend" className="text-sm text-gray-900">
                            {section.name}
                          </FormLabel>
                          <RadioGroup
                            name={section.id}
